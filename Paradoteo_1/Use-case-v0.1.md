...
4. Το συστημα εμφανιζει στον χρηστη ενα ερωτηματολογιο, το οποιο ο χρηστης συμπληρωνει και παταει "Submit Application"
...
1. Ο curator εντοπιζει το τραγούδι/αλμπουμ/ανακοίνωση το οποίο έχει παραβατικά στοιχεία
...
3. Έπειτα έχει την επιλογή για (βασική ροή issue strike/issue ban)
